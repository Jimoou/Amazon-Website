      ...
      <div class="row">
        ...
        >
          <div class="history-box">
            ...
            <!-- Product Buttons -->
            <div class="a-row">
              <a href="a" class="a-button-history margin-right-10">Update</a>
              <a href="a" class="a-button-history margin-right-10">Delete</a>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async fetchProducts() {
      try {
        let response = await this.$axios.$get('http://localhost:3000/api/products');
